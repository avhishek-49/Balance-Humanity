...
(() => {
  module.exports = async (call, res) => {
    try {
      ...
      let userExistCheck = await mysqlHelper.format(`SELECT uuid, customer_pin, password FROM sagar_test.balance_humanity_users WHERE mobile_number = "${call.mobileNumber}"`);
